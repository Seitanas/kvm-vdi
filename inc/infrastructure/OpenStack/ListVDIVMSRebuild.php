...
AS ephemeral_machine_name, vms2.clientid, vms2.osInstanceId AS ephemeral_osInstanceId, vms2.lastused FROM `vms` vms left JOIN vms vms2 ON vms.id=vms2.source_volume WHERE vms.machine_type = 'vdimachine'
