...
Additionally dashboard can provide thin client with a RDP session of remote machine (may be used as a backup solution), or a VM from vmWare horizon VDI pool (if used).
